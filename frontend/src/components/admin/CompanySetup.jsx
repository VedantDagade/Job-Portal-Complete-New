...
import { useSelector } from "react-redux";
import useGetCompanyById from "@/hooks/useGetCompanuById";
const CompanySetup = () => {
      ...
      <div className="max-w-xl mx-auto my-10">
        ...
        <form onSubmit={submitHandler}>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <Label className="my-3">Website</Label>
              <Input
                type="text"
                name="website"
                value={input.website}
            ...
            <div>
              <Label className="my-3">Location</Label>
              <Input
                type="text"
                name="location"
            ...
            <div>
              <Label className="my-3">Logo</Label>
              <Input
                type="file"
                accept="image/*"
